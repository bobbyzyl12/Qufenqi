...
<body>
		...
		<div class="main_container">
			...
			<div class="main_container_box">
				...
				<div class="message_box">
					<div class="user_msg">
						<p><span class="title_text">用户编号：</span><span id="userID">${user.userID}</span></p>
					...
					<div class="result_msg">
						<a href="${ctx}/user/passCheck?userID=${user.userID}"><button class="btn_pass">通过</button></a>
	...
	<div id="successDialog" class="dialog">
		<p class="dialog_msg">提交成功</p>
  		<a href="${ctx}/page/jumpToCheckUser" onclick="closeBg();"><button class="btn" style="width:120px;height:40px;font-size:18px;">下一个</button></a>
	</div>
	<div id="reasonDialog" class="dialog" style="height:360px;">
		...
		<div style="height:220px;padding:10px 30px 10px 30px;text-align:left;">
			...
			<p><input id="reasonCheckBox3" type="checkbox" style="margin-right:10px;">当前已支付金额过少</p>
		...
		if(check=="yes"){
			...
			$("#btn_reject").click(function(){
			    ...
			    $("#saveButton").click(function(){
			    	...
			    	if(ok){
			    		$.ajax({
		    				url: '${ctx}/user/rejectCheck',
		    				type: 'POST',
		    				data: {'reason':reason,'userID':user},
