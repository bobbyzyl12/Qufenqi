...
<body>
	...
	<div class="wrapper">
			...
			<div class="header_basic">
				<div class="header_box">
					...
					<div class="header_botton_box">
						<ul>
							<li>
								<a href="${ctx}/page/jumpToSignin" class="header_btn" style="border-width:0 2px 0 2px;">
				...
				<div class="login_form_box">
					<div class="input_box">
						...
						<div class="login_btn_box">
							...
							<a href="${ctx}/page/jumpToSignin"><button class="btn_signin">注册</button></a>
							<div style="position:relative;left:-50px;top:10px;text-align:right;">
								<a href="${ctx}/page/jumpToAdminLogin"><p class="other_role"> >系统管理员登陆</p></a>
								<a href="${ctx}/page/jumpToManaLogin"><p class="other_role">>审核员登陆</p></a>
							</div>
						</div>
		...
		<%}else{%>
			<script language='javascript'>document.location ="${ctx}/page/jumpToHomePage"</script>
			<div style="text-align:center;padding:20px;">
				<a href="${ctx}/page/jumpToHomePage"><p>正在跳转，如果服务器没有反应请点击这里</p></a>
			</div>
		<%}%>
	...
	<div id="lockDialog" class="dialog">
  		<p class="dialog_msg">该用户已冻结或已删除</p>
  		<a href="#" onclick="closeBg();"><button class="btn_login" style="width:120px;">关闭</button></a>
	</div>
