			...
			<div class="header_under">
				<div class="header_under_center">
					...
					<div class="header_search_box">
						<form action="${ctx}/goods/searchByClass" method="post">
		...
		<div class="main_container" style="overflow:auto;">
			...
			<%}else if((String)session.getAttribute("haveRes") == "yes"){%>
				<div class="pages" align="center">
					...
					<a href="${ctx}/goods/searchByClass?pageNo=${pageModel.pageNo-1}&&searchContent=${searchContent}"><button class="page_btn" style="width:100px" id="prePage">上一页</button></a>		
							
					<a href="${ctx}/goods/searchByClass"><button class="page_btn" id="page_btn1">1</button></a>
							
					<span class="pages_span" id="prePoint">...</span>
							
					<a href="${ctx}/goods/searchByClass?pageNo=${pageModel.pageNo-2}&&searchContent=${searchContent}"><button class="page_btn" id="page_btn2"></button></a>
							
					<a href="${ctx}/goods/searchByClass?pageNo=${pageModel.pageNo-1}&&searchContent=${searchContent}"><button class="page_btn" id="page_btn3"></button></a>
							
					<a><button class="page_btn" id="page_btn4"></button></a>
							
					<a href="${ctx}/goods/searchByClass?pageNo=${pageModel.pageNo+1}&&searchContent=${searchContent}"><button class="page_btn" id="page_btn5"></button></a>
							
					<a href="${ctx}/goods/searchByClass?pageNo=${pageModel.pageNo+2}&&searchContent=${searchContent}"><button class="page_btn" id="page_btn6"></button></a>
							
					<span class="pages_span" id="sufPoint">...</span>
							
					<a href="${ctx}/goods/searchByClass?pageNo=${pageModel.totalpage}&&searchContent=${searchContent}"><button class="page_btn" id="page_btn7"></button></a>
							
					<a href="${ctx}/goods/searchByClass?pageNo=${pageModel.pageNo+1}&&searchContent=${searchContent}"><button class="page_btn" style="width:100px;" id="sufPage">下一页</button></a>
					</ul>
				</div>
				<%}%>
			</div>
